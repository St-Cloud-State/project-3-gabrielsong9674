...
class View extends JFrame {
  ...
  private JButton polygonButton; //Polygon Button
  ...
  private JButton triButton; //Triangle Button
  ...
  public View() {
    ...
    triButton = new TriangleButton(undoManager, this, drawingPanel);

    //moveButton = new MoveButton(undoManager, drawingPanel);
    moveButton = new MoveButton(undoManager, model, drawingPanel);
    buttonPanel.add(moveButton);
    buttonPanel.add(lineButton);
    buttonPanel.add(polygonButton);  //polygon button
